...
# ===== MENU LATERAL (controle de etapa) =====
...
if opcao == "Dicionário de sintomas":
    from dicionario import dic  # importa o dicionário externo
...
# ===== AUTOTESTES (Hub) =====
    ...
    sistema_escolhido = st.selectbox("🔍 Escolha o sistema para testar:", list(sistemas_autotestes.keys()))
    subteste = st.radio("🧪 Escolha o teste específico:", sistemas_autotestes[sistema_escolhido])

    # ——— Router básico: implemente cada teste em funções separadas ———
    # Exemplo pronto e seguro para colar: "Tempo de Reação".
    if subteste == "Tempo de Reação":
        render_tempo_de_reacao()
    else:
        st.info("Selecione um teste implementado. (Posso te ajudar a colar os blocos de cada teste aqui.)")
